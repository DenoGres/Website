    ...
    <div class="min-h-screen min-w-screen text-white bg-gradient-to-b from-gray-600 to-gray-800">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
        ...
        <main class="col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4">
          ...
          <br />
          <p class={description}>
            DenoGres now includes a GUI that allows the user to introspect database
            schema and run queries. Furthermore, users can save database connections
            and previous queries to their accounts for later access.
          </p>
          <br />
          <h2 class={h2}>Getting Started</h2>
          <br />
          <p class={description}>
            To use the DenoGres app, make sure that DenoGres is installed in your
            project directory. Run the following command to launch the application:
          </p>
          <br />
          <div class={box}>
            denogres --gui
          ...
          <br />
          <p class={description}>
            First, create an account or log in to an existing one.
            Once signed in, you will be redirected to the app home page.
          </p>
          <br />
          <img class={gif} src="../login.gif"></img>
          <br />
          <p class={description}>
            The nav bar displays the different functionalities available at this time:
          </p>
          <br />
          <a class={anchor} name="database"></a>
          <img class={gif} src="../navbar_icons.jpeg"></img>
          <br />
          <br />
