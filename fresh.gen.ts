...
import * as $8 from "./routes/gui/api/handleConnectionSave.ts";
import * as $9 from "./routes/gui/api/handleQuerySave.ts";
import * as $10 from "./routes/gui/api/handleRequests.ts";
import * as $11 from "./routes/gui/api/logOut.tsx";
...
import * as $19 from "./routes/gui/logout.tsx";
import * as $20 from "./routes/gui/migrations.tsx";
...
const manifest = {
  routes: {
    ...
    "./routes/gui/api/handleConnectionSave.ts": $8,
    "./routes/gui/api/handleQuerySave.ts": $9,
    "./routes/gui/api/handleRequests.ts": $10,
    "./routes/gui/api/logOut.tsx": $11,
    ...
    "./routes/gui/logout.tsx": $19,
    "./routes/gui/migrations.tsx": $20,
    "./routes/index.tsx": $21,
  },
  islands: {
